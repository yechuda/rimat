...
SpalartAllmarasBF::SpalartAllmarasBF(const InputParameters & parameters) :
  Kernel(parameters),
  ...
  _body_force_vorticity_mag(coupledValueOld("body_force_vorticity_mag")),
...
Real SpalartAllmarasBF::computeQpResidual()
{
...
Real SpalartAllmarasBF::computeQpJacobian()
{
  RealVectorValue U(_u_vel[_qp], _v_vel[_qp], _w_vel[_qp]);
