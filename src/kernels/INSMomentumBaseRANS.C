...
INSMomentumBaseRANS::INSMomentumBaseRANS(const InputParameters & parameters) :
  Kernel(parameters),
...
Real INSMomentumBaseRANS::computeQpResidual()
{
...
Real INSMomentumBaseRANS::computeQpJacobian()
{
...
Real INSMomentumBaseRANS::computeQpOffDiagJacobian(unsigned jvar)
{
