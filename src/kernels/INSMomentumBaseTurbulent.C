...
INSMomentumBaseTurbulent::INSMomentumBaseTurbulent(const InputParameters & parameters) :
  Kernel(parameters),
...
Real INSMomentumBaseTurbulent::computeQpResidual()
{
...
Real INSMomentumBaseTurbulent::computeQpJacobian()
{
...
Real INSMomentumBaseTurbulent::computeQpOffDiagJacobian(unsigned jvar)
{
