...
SpalartAllmarasBFNonOld::SpalartAllmarasBFNonOld(const InputParameters & parameters) :
  Kernel(parameters),
...
Real SpalartAllmarasBFNonOld::computeQpResidual()
{
...
Real SpalartAllmarasBFNonOld::computeQpJacobian()
{
  RealVectorValue U(_u_vel[_qp], _v_vel[_qp], _w_vel[_qp]);
