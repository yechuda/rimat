...
{
  InputParameters params = validParams<INSMomentumLaplaceFormTurbulent>();
  return params;
}

INSMomentumLaplaceFormRZTurbulent::INSMomentumLaplaceFormRZTurbulent(const InputParameters & parameters) :
    INSMomentumLaplaceFormTurbulent(parameters)
{
}

Real
INSMomentumLaplaceFormRZTurbulent::computeQpResidual()
{
  // Base class residual contribution
  Real res_base = INSMomentumLaplaceFormTurbulent::computeQpResidual();
...
Real
INSMomentumLaplaceFormRZTurbulent::computeQpJacobian()
{
  // Base class jacobian contribution
  Real jac_base = INSMomentumLaplaceFormTurbulent::computeQpJacobian();
...
Real
INSMomentumLaplaceFormRZTurbulent::computeQpOffDiagJacobian(unsigned jvar)
{
  // Base class jacobian contribution
  Real jac_base = INSMomentumLaplaceFormTurbulent::computeQpOffDiagJacobian(jvar);
