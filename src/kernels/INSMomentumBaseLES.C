...
INSMomentumBaseLES::INSMomentumBaseLES(const InputParameters & parameters) :
  Kernel(parameters),
...
Real INSMomentumBaseLES::computeQpResidual()
{
...
Real INSMomentumBaseLES::computeQpJacobian()
{
...
Real INSMomentumBaseLES::computeQpOffDiagJacobian(unsigned jvar)
{
